...
def setTrafficBody(CampaignName, DailyBudget, AdsetStartTime, page):
    ...
    payload.setAdsetStartTime(AdsetStartTime)
    payload.setPage(page)
    json_body = {"data":{"campaign":{"name":"TrafficAPItesting","status":"PAUSED","objective":"Traffic","buying_type":"AUCTION","bid_strategy":"Lowest Cost","daily_budget":80,"campaign_budget":"DAILY_BUDGET"},"ads_groups":[{"ad":{"status":"ACTIVE"},"adset":{"status":"ACTIVE","billing_event":"IMPRESSIONS","adset_time_start":"2021-04-10T15:00:30+05:30","attribution_spec":[{"event_type":"CLICK_THROUGH","window_days":1}],"destination_type":"Website"},"ad_type":"image","creative":{"object_type":"SHARE","Creative Type":"Link Page Post Ad","instagram_actor_id":"2685713601466369","call_to_action_type":"LEARN_MORE"},"targeting":{"user_os":"All","targeting_optimization":"none","brand_safety_content_filter_levels":["FACEBOOK_STANDARD","AN_STANDARD"]},"story_spec":{"page_id":{"page_id":"107973334116438"},"instagram_actor_id":"2685713601466369"},"geo_locations":{"countries":[],"cities":[],"regions":[],"zips":[],"country_groups":[],"location_types":["home","recent"]},"excluded_geo_locations":{"countries":[],"cities":[],"regions":[],"zips":[],"country_groups":[],"location_types":["home"]}}],"name":"TrafficAPItesting","extras":{"ads_groups$geo_locations":[],"ads_groups$excluded_geo_locations":[],"ads_groups$targeting$flexible_spec":[],"ads_groups$targeting$excluded_flexible_spec":[]}}}
    return json_body
